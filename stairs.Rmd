...
```{r define glmmLasso for tidymodels workflow}

set_new_model("glmm_lasso")
set_model_mode(model = "glmm_lasso", mode = "classification")
set_model_engine(
  "glmm_lasso", 
  mode = "classification", 
  eng = "glmmLasso"
)
set_dependency("glmm_lasso", eng = "glmmLasso", pkg = "glmmLasso")
...
glmm_lasso <-
  function(fix = NULL, rnd = NULL, mode = "classification", lambda = NULL) {
...
set_fit(
  ...
  value = list(
   ...
   protect = c("fix", "rnd", "lambda"),
    func = c(pkg = "glmmLasso", fun = "glmmLasso"),
    defaults = list()
  )
)
